...
const data1 = [
  ...
  { x: 5, y: 52 }, { x: 6, y: 9 }, { x: 7, y: 18 }, { x: 8, y: 78 },
  { x: 9, y: 28 }, { x: 10, y: 34 }, { x: 11, y: 60 }, { x: 12, y: 25 }
];
const data2 = [
  { x: 1, y: 20 }, { x: 2, y: 80 }, { x: 3, y: 50 }, { x: 4, y: 60 },
  { x: 5, y: 30 }, { x: 6, y: 70 }, { x: 7, y: 90 }, { x: 8, y: 40 },
  { x: 9, y: 50 }, { x: 10, y: 75 }, { x: 11, y: 45 }, { x: 12, y: 10 }
];
    ...
    <div>
      <svg width={width} height={height}>
        <g transform={`translate(${MARGIN.left},${MARGIN.top})`}>
          ...
          <path d={linePath2} stroke="red" fill="none" strokeWidth={2} />
          <g ref={axesRef}></g>
        </g>
      </svg>
    </div>
