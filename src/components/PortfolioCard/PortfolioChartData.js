                    ...
                    {[...Array(5)].map((_, i) => (
                        <div key={i}>
                            <div className='flex gap-3'>
                                <img src='/images/Avatar.png' alt='' className='w-10 h-10 rounded-full' />
                                <div>
                                    <p className='text-white font-semibold text-sm'>John Doe</p>
                                    <p className='text-[#CCCED5] text-xs'>8:17 AM</p>
                                </div>
                            </div>
                            <p className='text-[#CCCED5] text-sm py-3 border-b'>Apple stocks seem to be holding steady despite the market fluctuations. Their recent product launches might have a positive impact on the stock performance.</p>
                        </div>
                    ))}
                </div>
                <div className='flex gap-3 pt-5 items-center'>
                    <input type='text' placeholder='Add Post' className='h-10 border border-[#4C546C] bg-transparent outline-none pl-4 text-white placeholder:text-sm rounded-full w-full placeholder:text-[#CCCED5]' />
