                ...
                <div className="flex h-24  items-center w-full justify-between">
                  ...
                  <div className="hidden md:block">
                    <div className=" flex gap-6 items-center ">
                      <div className="flex ">
                        {" "}
                        <p className="text-[#CCCED5] hidden md:block font-manrope text-sm">
                          Availlable Funds:
                        </p>
                        <p className="text-[#439CFF] hidden md:block text-sm font-manrope">
                          $6,074.00
                        </p>
                      </div>
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    <div className="ml-3">
                      <div className="flex ">
                        {" "}
                        <p className="text-[#CCCED5]  font-manrope text-sm">
                          Availlable Funds:
                        </p>
                        <p className="text-[#439CFF]  text-sm font-manrope">
                          $6,074.00
                        </p>
                      </div>
                    ...
                    <div className="relative ml-auto flex-shrink-0 flex gap-4 ">
                      <NotificationIcon />
                      <Language />
                    </div>
                  </div>
