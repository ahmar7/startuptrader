  ...
  return (
    <div className="flex md:flex-row flex-col gap-4 ">
        ...
        <div className="bg-[#1C2642]    rounded-2xl  p-24px mt-5 ">
          ...
          <div className="flex justify-between items-center">
            <div className="flex gap-3 pt-24px">
              ...
              <div>
                <p className="text-[#FFFFFF] text-[14px] font-semibold font-manrope">
                  John Doe
                </p>
                <div className="flex gap-2 ">
                  <p className="text-[#FF4045] text-[12px] font-medium font-manrope">
                    SELL
                  </p>
                  <p className="text-[#FFFFFF] text-[12px] font-manrope">
                    HQ at 125.00
                  </p>
                </div>
              </div>
                ...
                <div className="flex gap-3 pt-24px">
                  <div>
                    <div className="flex justify-between">
                      ...
                      <p className="text-[10px] font-manrope text-[#FFFFFF]">
                        8:17 AM
                      </p>
                    </div>
                    <p className="text-[#FFFFFF] text-[12px] font-manrope">
      ...
      <div className=" md:w-[30%] flex flex-col h-full ">
        <div className="bg-[#1C2642]   rounded-2xl   p-24px mt-5 ">
          <div className="flex justify-center items-center">
            {["Buy/Sell", "Short"].map((v, i) => (
              <p
                className={`w-[50%] flex font-manrope text-[#FFFFFF] font-semibold text-[12px] justify-center items-center border-b pb-3 ${
                  "Buy/Sell" == v ? "border-[#439CFF]" : ""
                }`}
              >
                {v}
              </p>
          ...
          <div className="flex justify-between">
            ...
            <p className="text-[18px] font-manrope font-semibold text-[#FFFFFF]">
              $330.00
            </p>
          </div>
          <div className="flex gap-4 w-full mt-4">
            <button
              style={{
                backgroundImage:
                  "linear-gradient(273.67deg, #F02D16 1.4%, #C81803 94.13%)",
              }}
              className="  font-manrope text-white text-sm h-[32px]  px-1 rounded-full w-full shadow-md transition-all duration-300 ease-in-out"
            >
              Sell
            </button>
        ...
        <div className="bg-[#1C2642]   rounded-2xl   p-24px mt-5 ">
          <div className="flex justify-between items-center">
            <p className="text-[18] font-manrope font-bold text-[#FFFFFF] pb-5">
              Live feed
            </p>
            <div className="flex gap-1 items-center">
              <UserIcon />
              ...
              <div className="border-b py-3">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex gap-3 pt-4">
                    <div className="flex gap-1 items-center">
                      <HeartIcon />
                      <p className="text-[10] font-manrope  text-[#CCCED5]">
                        1221
                      </p>
                    </div>
                    <div className="flex gap-1 items-center">
