...
const ExchangeStartUp = () => {
  return (
    ...
    <div className='flex gap-4'>
        ...
        <div className='flex items-center gap-2 rounded-full border border-[#4C546C] px-3  w-[200px] h-10 justify-center'><StarIcon /><p className='text-[#E5E7EA] text-[12px] font-manrope font-semibold'>Add to Watchlist</p></div>
    
        </div>
        </div>
        <p className='text-[#FF4045] font-manrope font-semibold text-[12px]'>Claim Company</p>
        </div>
        <div className='flex md:flex-row flex-col pt-5 gap-6'>
        ...
        {i!==2 &&  <div className='border-l-2 md:block hidden border-[#FFFFFF]' />}
    ...
    <div className='bg-[#1C2642]  rounded-lg md:w-[30%] p-5 mt-5 '>
        ...
        <div className='h-[200px] overflow-y-auto'>
            {[...Array(12)].map((_,i)=>   <div className='flex justify-between border-b border-[#333C57] py-2'>
        <div className='flex items-center text-center '>
          <UpValueIcon />
          <p className='text-[#3DCC43] pl-1 text-sm'>+2.22%</p>
        
        </div>
            <p className='text-[12px] font-manrope font-medium text-[#FFFFFF]'>$1.00</p>
            <p className='text-[12px] font-manrope font-medium text-[#FFFFFF]'>$1.00</p>
            <p className='text-[12px] font-manrope font-medium text-[#FFFFFF]'>$1.00</p>
        </div>)}
