...
const DashboardProfileCard = () => {
  return (
    <div className="bg-[#1C2642] lg:justify-between flex lg:flex-row flex-col rounded-2xl w-full p-24px ">
      <div className="flex md:flex-row flex-col items-center  space-x-6">
        ...
        <div className="font-manrope">
          ...
          <div className="flex">
            {" "}
            <p className="text-[#CCCED5]">Rank:</p>
            <p className="text-white font-semibold">1st Tier Investor</p>
          </div>
          <div className="flex">
            <p className="text-[#CCCED5]"> Member since:</p>
            <p className="text-white font-semibold">June 2023</p>
          </div>
          <button className="text-[#CCCED5] px-4 py-1 mt-3 rounded-full border border-[#CCCED5]">
            Watch
          </button>
        </div>
      </div>

      <div className="border font-manrope mt-5 md:flex-row lg:w-[50%] gap-4 flex-col w-full flex p-24px text-[#CCCED5] border-[#333C57] rounded-lg ">
