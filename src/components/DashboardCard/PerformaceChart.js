...
const PerformanceChart = () => {
  return (
    <div className="bg-[#1C2642] flex flex-col lg:flex-row mt-5 font-manrope p-24px rounded-2xl  w-full gap-4">
      ...
      <div className="w-full lg:w-1/4 flex flex-col gap-24px">
        <div className="border p-24px rounded-2xl  border-[#4C546C]">
          <div className="flex items-center gap-1">
            <div className="bg-[#3DCC43] w-3 h-3 rounded-full" />
          ...
          {[...Array(3)].map((v, i) => (
            <div
              key={i}
              className="flex justify-between items-center border-b-[#333C57] border-b py-2"
            >
              <img src={`/images/pp${i}.png`} alt="" className="w-8" />
              <p className="font-medium text-[#FFFFFF] text-[12px]">
                Company name
              </p>
        ...
        <div className="border p-24px rounded-2xl  border-[#4C546C]">
          <div className="flex items-center gap-1">
            <div className="bg-[#FF4045] w-3 h-3 rounded-full" />
            <p className="text-base font-bold text-[#CCCED5]">
              Worst Performers
            </p>
          </div>
          <div className="flex text-[10px] text-[#CCCED5] py-2 border-b justify-between items-end">
